...
**Job stipends added.** Random bonus drops while you work your career: 5% chance of gunpowder per block mined as Miner, 7% bone meal per crop harvested as Farmer, 10% arrows per monster kill as Hunter, and so on down the list. It feeds the supply chains (gunpowder for TNT, fireworks, and beacons; bone meal for farms) and lifts new-player income by 10–15%.
...
- **World borders settled.** Main world 4,000 radius, resource world 2,500 radius, nether resource 1,250 radius.
