...
<InfoCallout type="warning" title="Current status">
  The law system described below is the design for Season 0's civic layer. **There are currently no player police officers — all enforcement is handled by staff.** Report crimes on Discord or to staff in-game; fines and restitution are applied by staff where the laws below call for them.
</InfoCallout>
