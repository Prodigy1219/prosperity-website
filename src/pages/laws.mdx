...
<InfoCallout type="info" title="Laws vs Server Rules">
  This page covers **in-game crimes** — offenses handled by the server's law system through fines, jail, and courts. Server rule violations (hacking, griefing, harassment) are handled separately by staff. See the [server rules](https://wiki.prosperitysmp.com/Server_rules) for those.
</InfoCallout>
